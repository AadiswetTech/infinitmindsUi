...
<div className="dsk-logo"><a className="nav-brand" href="index-2.html">
<img src="./logo.png" alt="Logo" className="mega-white-logo" />
<img src="./logo.png" alt="Logo" className="mega-darks-logo" />
</a>
</div>
...
<ul>
<li><a href="index.html">All Demo <span className="badge bg-primary">New</span></a></li>
...
<li className="sbmenu">
<a href="#" className="menu-links">Shortcodes</a>
<div className="nx-dropdown">
<div className="sub-menu-section">
<div className="container">
<div className="sub-menu-center-block">
...
<li className="hidedesktop darkmodeswitch"><div className="switch-wrapper"> <label className="switch" htmlFor="niwax"> <input type="checkbox" id="niwax" /> <span className="slider round"></span> </label> </div> </li>
...
<li className="prb">
<a href="https://separateweb.com/cdn-cgi/l/email-protection#cfbca0a2aab8aaada2aaaba6ae8fa8a2aea6a3e1aca0a2">
