...
<div className="wide-block service-img2" data-tilt data-tilt-max="2" data-tilt-speed="600">
<div className="block-space-">
<span>MARKETING </span>
...
<div className="wide-block service-img3" data-tilt data-tilt-max="2" data-tilt-speed="600">
<div className="block-space-">
<span>SEO</span>
...
<section className="why-choos-lg-nx pad-tb deep-dark bg-gradient10">
<div className="container">
<div className="row">
...
<div className="img-ab- base" data-tilt data-tilt-max="20" data-tilt-speed="1000"><img src="./icons/worker.svg" alt="icon" className="layer"/></div>
<div className="media-body">
...
<div className="media mt40">
<div className="img-ab- base" data-tilt data-tilt-max="20" data-tilt-speed="1000"> <img src="./icons/deal.svg" alt="icon" className="layer"/></div>
<div className="media-body">
